                ...
                <div class="card-body">
					...
					<div class="media">
						<div class="d-flex flex-column vote-controls">
							<a title="this questin is useful" class="vote-up"><i class="fas fa-caret-up fa-2x"></i> </a>
							<span class="vote-count">445</span>
							<a title="this questin is useful" class="vote-down off"><i class="fas fa-caret-down fa-2x"></i></a>
							<a title="click to mark as favorit question (click again to undo)" class="favorite"><i class="fas fa-star fa-2x"></i>
